...
function getAudioInfo(){
  tracks.value.source=information.value.musicUrl
...
const favorite = () => {
  tracks.value.favorited = !tracks.value.favorited;
};

const playMusic=()=>{
  // console.log(tracks.source);
  audio.value.src = tracks.value.source;
...
// const changeUrl=()=>{
//   tracks.value.source=mUrl.value;
//   playMusic()
// }
onMounted(() => {
  playMusic()
      ...
      <div class="player">
        <div class="player__top">
          <div class="player-cover">
            <img class="player-cover__item"  :src="tracks.cover" alt="" >
          </div>
          <div class="player-controls">
            <div class="player-controls__item -favorite" :class="{ active : tracks.favorited }" @click="favorite">
              <svg class="icon">
                <use xlink:href="#icon-heart-o"></use>
              </svg>
            </div>
            <a :href="tracks.url" target="_blank" class="player-controls__item">
              <svg class="icon">
        ...
        <div class="progress" ref="progress">
          <div class="progress__top">
            <div class="album-info" >
              <div class="album-info__name">{{ tracks.artist }}</div>
              <div class="album-info__track">{{ tracks.name }}</div>
            </div>
